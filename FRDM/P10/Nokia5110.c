...
// Reset         (RST, pin 1) connected to PTC3
// SSI0Fss       (CE,  pin 2) connected to PTC2
// Data/Command  (DC,  pin 3) connected to PTC4
// SSI0Tx        (Din, pin 4) connected to PTC6
// SSI0Clk       (Clk, pin 5) connected to PTC5
