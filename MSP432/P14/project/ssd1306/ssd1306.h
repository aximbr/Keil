...
#define SSD1306_I2C_PORT		EUSCI_B0_BASE
#endif

#ifndef SSD1306_I2C_ADDR
#define SSD1306_I2C_ADDR        (0x3C)  //MSP432 register for slave address for other MCU use (0x3C << 1)
#endif
...
//extern uint32_t SSD1306_I2C_PORT;
