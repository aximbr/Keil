...
void hal_i2c_init(I2C_TypeDef* i2cx){
  ...
  MyI2C_init.I2C_DutyCycle = I2C_DutyCycle_2;
  MyI2C_init.I2C_Mode = I2C_Mode_I2C;
	MyI2C_init.I2C_OwnAddress1 = 0;
	MyI2C_init.I2C_Ack = I2C_Ack_Enable; //Enable ACK
  MyI2C_init.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;
