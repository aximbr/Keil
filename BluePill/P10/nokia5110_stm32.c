...
SPI_SSOutputCmd(SPI1,ENABLE); //configura o CS
//SPI_Cmd(SPI1, ENABLE); 

// Configure SPI - CS PA4, CLK PA5, MOSI PA7
...
LCD_write_byte (0xAF, 0); // set the contrast
...
delayMs(1);	                     /* apenas para estabilizar o clock */
